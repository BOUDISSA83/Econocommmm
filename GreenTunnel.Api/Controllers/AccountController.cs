...
namespace GreenTunnel.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        {
            var result = await _mediator.Send(new GetUsersQuery { PageNumber = pageNumber, PageSize = pageSize });
            return Ok(result);
        }
        ...
        {
            var roles = await _mediator.Send(new GetRolesLoadRelatedQuery() { Page = pageNumber,PageSize = pageSize});
