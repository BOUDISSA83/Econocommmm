...
export class NotificationEndpoint {
  ...
  getNotificationEndpoint<T>(notificationId: number): Observable<T> | any {
  ...
  getNotificationsEndpoint<T>(page: number, pageSize: number): Observable<T> | any {
  ...
  getUnreadNotificationsEndpoint<T>(userId?: string): Observable<T> | any {
  ...
  getNewNotificationsEndpoint<T>(lastNotificationDate?: Date): Observable<T> | any {
  ...
  getPinUnpinNotificationEndpoint<T>(notificationId: number, isPinned?: boolean, ): Observable<T> | any {
  ...
  getReadUnreadNotificationEndpoint<T>(notificationIds: number[], isRead: boolean, ): Observable<T> | any {
  ...
  getDeleteNotificationEndpoint<T>(notificationId: number): Observable<T> | any {
  ...
  private createResponse<T>(body:any, status: number) {
