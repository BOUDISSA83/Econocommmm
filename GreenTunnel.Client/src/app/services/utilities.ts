...
export class Utilities {
  ...
  public static findHttpResponseMessage(messageToFind: string, data: HttpResponse<any> | any, searchInCaptionOnly = true, includeCaptionInResult = false): string | any {
  ...
  public static splitInTwo(text: string, separator: string, splitFromEnd = false): { firstPart: string, secondPart: string | any } {
  ...
  public static GetObjectWithLoweredPropertyNames(obj: any) {
    const loweredObj = Object.keys(obj).reduce((newObj:any, k:any) => {
  ...
  public static toLowerCase(items: string):any;
  public static toLowerCase(items: string[]):any;
  public static toLowerCase(items: any): string | string[] | any {
  ...
  public static getAge(birthDate:any, otherDate:any) {
  ...
  public static moveArrayItem(array: any[], oldIndex:any, newIndex:any) {
  ...
  public static removeNulls(obj:any) {
